...
public class NamedClusterComposite extends Composite {
  ...
  private interface Callback {
    public void invoke( NamedCluster nc, String value );
  }
  
  public NamedClusterComposite( Composite parent, NamedCluster configuration, PropsUI props ) {
  ...
  private void processConfiguration( final Composite c, final NamedCluster cluster ) {
  ...
  private Composite createConfigurationUI( final Composite c, final NamedCluster configuration  ) {
  ...
  private void createHdfsGroup( Composite parentComposite, final NamedCluster c ) {
    Composite pp = createGroup( parentComposite, "HDFS" );

    // hdfs host label
    createLabel( pp, "Hostname" + ":", SWT.NONE );
    // hdfs host input
    ...
    // hdfs user label
    createLabel( pp, "Username" + ":", SWT.NONE );
    // hdfs user input
    ...
    // hdfs password label
    createLabel( pp, "Password" + ":", SWT.NONE );
    // hdfs user input
    ...
    createTextVar( c, pp, "" + c.getHdfsUsername(), gridData, PASSWORD_FLAGS, hdfsPasswordCB );       
  }  
  
  private void createNameNodeGroup( Composite parentComposite, final NamedCluster c ) {
    Composite pp = createGroup( parentComposite, "NameNode" );
  ...
  private void createJobTrackerGroup( Composite parentComposite, final NamedCluster c ) {
    Composite pp = createGroup( parentComposite, "JobTracker" );
  ...
  private void createOozieGroup( Composite parentComposite, final NamedCluster c ) {
    Composite pp = createGroup( parentComposite, "Oozie" );
