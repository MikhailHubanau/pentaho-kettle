...
public class UIObjectRegistry {
  ...
  public static final Class<?> DEFAULT_NAMED_CONFIGURATION_CLASS = UINamedCluster.class;
  ...
  public UINamedCluster constructUINamedCluster( NamedCluster namedCluster, Repository rep ) throws UIObjectCreationException {
    try {
      Constructor<?> constructor = namedConfigurationClass.getConstructor( NamedCluster.class, Repository.class );
      if ( constructor != null ) {
